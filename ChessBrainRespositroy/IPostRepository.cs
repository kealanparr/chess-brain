...
namespace ChessBrainRespository
{
        ...
        {
            ChessBrainBackEnd.Pocos.Post GetPostsById(int PostId);

            ChessBrainBackEnd.Pocos.Post GetTitleById(int PostId);

            ChessBrainBackEnd.Pocos.Post GetContentById(int PostId);
